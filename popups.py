...
class TemperaturaPopup(Popup):
    """
    Popup que informa a temperatura do motor
    """
    pass

class CorrentePopup(Popup):
    """
    Popup que informa as corrente de fase do motor
    """
    pass

class TensaoPopup(Popup):
    """
    Popup que informa a tensão entre as fases do motor
    """
    pass
...
class HistGraphPopup(Popup):
    def __init__(self,**kwargs):
        ...
        for key,value in kwargs.get('tags').items():
            if key == 'torque' or key == 'carga' or key == 'freq_rot' or key == 'vel_est' or key == 'P' or key == 'Q' or  key == 'S' or key == 'current':
