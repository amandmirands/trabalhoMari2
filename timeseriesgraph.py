...
class TimeSeriesGraph(Graph):
    ...
    def update_x_labels(self,timestamps=None):
        """
        Método para atualização do eixo das abscissas com os valores dos timestamps das amostras
        :param timestamps: vetor com os timestamps, caso não seja passado como argumento, 
        será utilizado o vetor interno, que é atualizado por meio do método updateGraph
        """
    ...
    def _addTimeLabels(self, *args):
        """
        Método privado utilizado para atualizar os rótulos do eixo das abscissas de acordo com o vetor de timestamps.
    ...
    def setMaxPoints(self, mp, plot_number):
        """
        Método utilizado para definir o número máximo de pontos de um determinado plot.
        :param mp: número máximo de pontos desejado
        :param plot_number: número do plot em que se deseja alterar o número de pontos
        """
        try:
            self._max_points = mp
            if mp == 100:
